...
export default function Thucan() {
    ...
    <div className = "grid grid-cols-6">
        ...
        <div className="flex items-center p-2 space-x-4">
            <img src="https://scontent.fsgn2-1.fna.fbcdn.net/v/t1.6435-9/183467649_582787963114419_7642949298340341363_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=174925&_nc_ohc=muS3_PoGc78AX-Q5O9a&_nc_oc=AQn2cIqfO2gRwu6EtNJYzyFcMfN0HdzVpK-iLag5HpxAQeyR8kxDxQb-sax2_F-L1JNzKANuObPw9Zv1oNMviCnP&_nc_ht=scontent.fsgn2-1.fna&oh=adef84af0ca3c7436c4ce32234621e2c&oe=61A0C4C2" alt className="w-12 h-12 rounded-full bg-coolGray-500" />
            <div>
        ...
        <div className="divide-y divide-coolGray-300">
            ...
            <li>
                ...
                <div class = "transition duration-500 ease-in-out bg-blue-600 hover:bg-red-600 transform hover:-translate-y-1 hover:scale-110 tex text-lg p-1 m-5">Settings</div>
                </a>
            </li>
            <li>
                <a href="#" className="flex items-center p-2 space-x-3 rounded-md">
                ...
                <div class = 'transition bg-red-400  duration-700 ease-in-out '>Logout</div>
                </a>
            </li>
            </ul>
        </div>
    ...
    <h3 className = "text-center text-red-100 text-8xl mt-5 cursor-pointer">Menu</h3>
    ...
    <div className="flex flex-wrap -m-4">
            {_.filter(data, item => item.maDanhMuc === maDanhMuc).map((item,index)=> {
                ...
                <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                  ...
                  <a className="text-indigo-500 cursor-pointer inline-flex items-center" onClick={()=>{
                      setOpenModal(true);
                      setItem(item);
                  }}>Chi Tiết
                  ...
                  <div className="text-right leading-none flex justify-end absolute bottom-0 left-0 w-full py-4">
                    <span className="text-gray-400 mr-3 inline-flex items-center leading-none text-sm pr-3">
                    Giá : {item.gia}
                </span>
